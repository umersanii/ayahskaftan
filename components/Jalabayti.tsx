...
export default function LigneeOr() {
  const products = [
    ...
    },
    {
      ...
      image:
        "/jalabayti/IMG_2607.webp",
      price: "€699,00",
    },
  ];

  return (
    <section className="py-24 bg-gradient-to-b from-orange-50 to-amber-100">
          ...
          {products.map((product) => (
            <div key={product.id} className="group cursor-pointer">
              <div className="relative overflow-hidden mb-6 aspect-[9/15] bg-white rounded-lg shadow-sm">
                ...
                <div className="absolute bottom-4 left-4 right-4 opacity-0 group-hover:opacity-100 transition-all duration-3000">
